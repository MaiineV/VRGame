...
namespace Gameplay.Interactions
{
    ...
    public sealed class GrabGateEnforcer : MonoBehaviour
    {
        ...
        void Update()
        {
            // Retry the lookup: ShelfSlot adds BottleUnlockGate via AddComponent right after
            // Instantiate, which runs after this Awake() already fired — caching null here forever
            // would silently disable the veto for every shelf-spawned bottle.
            if (_gate == null) _gate = GetComponentInParent<IGrabGate>();
